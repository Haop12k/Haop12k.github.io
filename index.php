...
<div class='profile-card__name'> Phan Võ Anh Hào <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Phan Võ Anh Hào</b>, một cậu sinh học sinh cấp 1 sắp lên cấp 2 yeye chuyên <b>Hỗ trợ Dịch vụ Mạng Xã Hội</b> với ước mơ trở thành một Developer chuyên nghiệp. Tôi thích khám phá, tìm tòi và học hỏi những điều thú vị trên mạng Internet. Biết đôi chút về <i> Python, HTML5/CSS3, JavaScript</i> ...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Vĩnh Long</span>
</div>
<div class='profile-card-inf'>
<div class='profile-card-inf__item'>
<div class='profile-card-inf__title' id='count-followers'>1 tỷ=))</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/haophan06/' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-facebook'></use></svg>
</span>
</a>
<a class='profile-card-social__item link' href='https://www.facebook.com/haophan06/' target='_blank'>
<span class='icon-font'>
